...
const RegisterMobileVersion = ({ setSuccess }) => {
  ...
  return (
    <>
      <form onSubmit={formik.handleSubmit} className="register-mobile">
        ...
        <div className="w-full relative">
          ...
          <input
            ...
            onBlurCapture={() =>
              (eyesConfirmRef.current.style.color = "#191414")
            }
...
export default RegisterMobileVersion;
